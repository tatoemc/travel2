                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary btn-sm" href="{{ route('hajs.index') }}">رجوع</a>
                        </div>
                    </div><br> 
                    
                        {!! Form::open(['route'=>'hajs.store', 'method'=>'POST','autocomplete'=>'off','files'=>'true','class'=>'form']) !!}  
                        {{csrf_field()}}
                        <input type="hidden" name="service_id" id="id" value="4">
         
                        <div class="">
                            <div class="row mg-b-20">
                               
                                <div class="col">
                                    <label>اختيار المناسك</label>
                                    <select name="name" id="select-beast" class="form-control  nice-select  custom-select">
