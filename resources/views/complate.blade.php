...
<html lang="en">
  <head>
    <title>mostafa - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">info@del-group.com</span>
					    </div>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-5 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <form action="{{ url('/') }}" class="search-location" autocomplete="off">
	        		<div class="row">
	        			<div class="col-lg align-items-end">
	        				<div class="form-group">
	          				<div class="form-field">
			                <input type="text" name="search" class="form-control" placeholder="Search Vans">
