                ...
                <div class="card-body">
                    <form action="{{ route('vans.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="van_id" class="control-label"> الرقم التسلسلي</label>

                                <input type="text" class="form-control" id="van_id" name="van_id" placeholder="ادخل الرقم التسلسلي" required>
                            </div>
