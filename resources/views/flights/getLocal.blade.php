                        ...
                        <div class="">
                            <div class="row mg-b-20">
                                <div class="parsley-input col-md-3" id="fnWrapper">
                                    ...
                                    <select name="to" id="select-beast" class="form-control  nice-select  custom-select">
                                        <option value="" selected disabled> -- اختيار المدينة--</option>
                                        <option value="بورتسودان">بورتسودان</option>
                                        <option value="جبل مرة">جبل مرة</option>
                                        <option value="كسلا">كسلا</option>
                                        <option value="حلفاء">حلفاء</option>
                                        <option value="كادوقلي">كادوقلي</option>
